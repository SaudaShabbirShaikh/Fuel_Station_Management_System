                ...
                <div class="h-100 d-flex">
                    <div class="w-100">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="0" step="any" name="liter" id="liter" class="form-control form-control-sm rounded-0" required>
                        </div>
                        <div class="form-group">
                            <label for="amount" class="control-label fw-bold text-light">Amount</label>
                            <input type="number" value="0" step="any" name="amount" id="amount" class="form-control form-control-sm rounded-0 " required>
                        </div>
                        <div class="form-group">
                            <label for="discount" class="control-label fw-bold text-light">Discount %</label>
                            <input type="number" min="0" max="100" step="any" name="discount" id="discount" class="form-control form-control-sm rounded-0 " value="0" required>
                        </div>
                        <div class="form-group">
                            <label for="total" class="control-label fw-bold text-light">Total</label>
                            <input type="number" value="0"  step="any" name="total" id="total" class="form-control form-control-sm rounded-0 " readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="tendered_amount" id="tendered_amount" class="form-control form-control-sm rounded-0 " value="0">
                        </div>
                        <div class="form-group">
                            <label for="change" class="control-label fw-bold text-light">Change</label>
                            <input type="number" step="any" name="change" id="change" class="form-control form-control-sm rounded-0 "  value="0" readonly>
                        </div>
                    </div>
                </div>
            </div>
