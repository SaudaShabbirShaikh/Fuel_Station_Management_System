        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-right p-0 px-1">Customer Code</th>
                    <th class="text-right p-0 px-1">Customer</th>
                    <th class="text-right p-0 px-1">Remaining Balance</th>
            ...
            <tbody>
                ...
                while($row = $qry->fetchArray()):
                    ...
                    <tr class="">
                        ...
                        <td class="py-1 px-2 text-right"><?php echo number_format($row['balance']) ?></td>
