            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact"  id="contact" required class="form-control form-control-sm rounded-0" maxlength="10" value="<?php echo isset($contact) ? $contact : '' ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
<script>
    $(function(){
        $('#customer-form').submit(function(e){
            if($('#email').val() <= 0 || $('#fullname').val() <= 0 || $('#address').val() <= 0 ){
